...
export default function CrudMunicipalities() {
  
  const [Municipaliti, setMunicipalities] = useState([]);
  const getData = async () => {
    axios.get('http://127.0.0.1:8000/api/municipalities').then(data => {
